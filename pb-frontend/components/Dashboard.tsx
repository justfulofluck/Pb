  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs onHomeClick={onHomeClick} steps={[{ label: 'Dashboard' }]} className="mb-8" />
                ...
                >
                  ...
                  <div className={`p-8 rounded-[40px] bg-gradient-to-br ${tierColors[userData.tier] || 'from-slate-900 to-black'} text-white relative overflow-hidden shadow-2xl`}>
                    <div className="relative z-10 space-y-4">
                      ...
                      <p className="font-handdrawn text-2xl text-white/70">Fueling your ambition since {new Date(authUser.date_joined || Date.now()).getFullYear()} ✨</p>
                    </div>
                    {/* Decorative Elements */}
                        ...
                        >
                          ...
                          <div className="text-right">
                             ...
                             <span className={`inline-block px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider mt-1 ${
                                order.status === 'Delivered' ? 'bg-green-100 text-green-600' : 'bg-orange-100 text-accent-brown'
                             }`}>
                                {order.status}
                             </span>
                          </div>
              ...
              {activeTab === 'profile' && (
                ...
                >
                  <div className="mb-12 border-b border-slate-100 pb-8">
                    ...
                    <p className="font-handdrawn text-2xl text-slate-400 mt-2">Personalize your Pinobite experience</p>
                  </div>
                ...
                >
                    <div className="bg-white p-8 md:p-12 rounded-[40px] border border-slate-100 shadow-sm overflow-hidden relative">
                         <div className="relative z-10 max-w-xl">
                            ...
                            <p className="font-handdrawn text-2xl text-primary mt-2">The more you fuel, the more you save!</p>
        ...
        {selectedOrder && (
            ...
            >
                ...
                <div className="pt-8 border-t border-dashed border-slate-100 flex flex-col items-center">
                    <p className="text-center text-slate-400 font-handdrawn text-2xl">
