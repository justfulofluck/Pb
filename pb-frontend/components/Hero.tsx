...
const Hero: React.FC<HeroProps> = ({ onShopClick, slides }) => {
  ...
  return (
    <section
      className="relative overflow-hidden h-screen flex items-center transition-colors duration-700 ease-in-out"
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-2 md:order-1 relative h-[300px] flex items-center">
            {activeSlides.map((slide, index) => (
              <div
                key={slide.id}
                className={`absolute inset-0 flex flex-col justify-center text-center md:text-left transition-all duration-700 ease-out ${index === currentSlide
