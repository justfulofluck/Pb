    ...
    <div className="bg-background-light min-h-screen pb-24 animate-in fade-in duration-500">
      <div className="bg-emerald-50/50 pt-10 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-normal !normal-case text-slate-900 tracking-tight leading-[1] mb-6 font-anton">
            Refunds & returns
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="bg-white rounded-[40px] shadow-xl border-2 border-slate-50 p-8 md:p-16 relative overflow-hidden prose prose-slate prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Satisfaction guarantee</h2>
          <p>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Return window</h2>
          <p>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Eligibility criteria</h2>
          <p>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Non-returnable items</h2>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Return process</h2>
          <p>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Shipping costs</h2>
          <p>
            You will be responsible for paying for your own shipping costs for returning your item. Shipping costs are non-refundable. If you receive a refund, the cost of return shipping will be deducted from your refund.
          </p>

          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Processing time</h2>
          <p>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Damaged or defective products</h2>
          <p>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Refund method</h2>
          <p>
          ...
          <h2 className="text-2xl font-normal !normal-case text-slate-900 mt-12 mb-6 tracking-tight font-anton">Exchanges</h2>
          <p>
