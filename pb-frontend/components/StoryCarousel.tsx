      ...
      <div className="max-w-7xl mx-auto px-4 relative flex flex-col items-center">
        ...
        <div className="text-center mb-8 md:mb-16 relative w-full flex flex-col items-center">
          ...
          <div className="relative inline-block">
            <h2
              className="font-normal tracking-wide [word-spacing:0.05em] leading-[1.1] !font-anton uppercase text-textured-green"
              style={{ textTransform: 'uppercase', fontSize: '40px' }}
            >
              Social stories
            </h2>
          </div>
