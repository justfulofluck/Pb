...
const ProductPage: React.FC<ProductPageProps> = ({
  ...
  return (
    <div className="page-wrapper" style={{ opacity: 1, backgroundColor: tintColor }}>
      ...
      <section ref={heroRef} style={{ backgroundColor: bgColor }} className="section overflow-hidden min-h-[70vh] md:min-h-[95vh] flex flex-col items-center pt-0 pb-16 md:pb-24 texture-overlay texture-speckles">
        <div className="w-layout-blockcontainer container product-page-hero w-container !pt-2 md:!pt-6 !mt-0">
          <div className="content-wrapper product-page-hero">
            <div className="heading-text-box pdp-h1 mt-0 pt-0 px-[220px] mb-[-10rem]">
            ...
            <div className="product-page-hero-bottom-content flex flex-col lg:flex-row items-center lg:items-end justify-between relative px-2 md:px-0 mt-4 lg:mt-0 lg:pb-35">
              <div className="content-block pdp-01 w-full lg:w-[22%] order-2 lg:order-1 mt-6 lg:mt-[-40px] flex flex-col items-center lg:items-start">
                <div className="hidden md:block text-box pdp-description text-center lg:text-left mx-auto lg:mx-0 px-2 sm:px-4 md:px-0" data-snaxxo-animate>
                  <div className="pdp-ingredients-popup-container flex justify-center lg:justify-start">
                    <a onClick={(e) => { e.preventDefault(); setShowIngredients(true); onPopupToggle?.(true); }} style={{ borderColor: '#008a45', cursor: 'pointer' }} className="pdp-nutrition-popup-toggle w-inline-block hover:bg-white/10 transition-colors py-2 px-4 border rounded-full">
                      <p style={{ color: '#008a45' }} className="paragraph no-margin !text-[10px] sm:!text-xs uppercase tracking-widest font-bold">Nutrition &amp; Ingredients</p>
                      <div className="pdp-plus w-embed ml-2 w-3 h-3 sm:w-4 sm:h-4">
                        <svg xmlns="http://www.w3.org/2000/svg" style={{ width: 'inherit', height: 'inherit' }} fill="#008a45" viewBox="0 0 256 256">
              ...
              <div className="content-block pdp-03 w-full lg:w-[25%] order-3 lg:order-3 mt-10 lg:mt-[-40px] flex flex-col items-center lg:items-end justify-center lg:justify-end mx-auto lg:mx-0" data-snaxxo-animate>
                <div className="pdp-hero-right-block-content mb-0 flex flex-col items-center lg:items-end w-full mx-auto lg:mx-0">
                  ...
                  <p style={{ color: 'rgba(255, 255, 255, 0.6)' }} className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] mt-0 text-center lg:text-right">MRP (Inclusive of all taxes)</p>
                </div>
                <div className="add-to-cart-block-wrapper _02 w-full max-w-sm mx-auto lg:mx-0">
                  <form onSubmit={handleAddToCart} className="w-commerce-commerceaddtocartform default-state w-full">
                    <div className="product-page-info-cta-contain flex flex-col sm:flex-row gap-3 items-center justify-center lg:justify-end h-[40px] md:h-[48px]">
                      <div style={{ borderColor: 'rgba(255,255,255,0.3)' }} className="quantity-wrapper flex items-center border rounded-lg h-[40px] md:h-[48px] !w-[140px] !min-w-[140px] !max-w-[140px] overflow-hidden">
                        <button
                          type="button"
                      ...
                      <input
                        className="w-commerce-commerceaddtocartbutton add-to-cart-button-main product-page cursor-pointer transition-transform hover:scale-105 !w-[160px] !min-w-[160px] !max-w-[160px]"
                        style={{ backgroundColor: '#FFF', color: '#008a45', height: '100%', minHeight: '40px', borderRadius: '8px', fontSize: '0.95rem', fontWeight: '900', textTransform: 'uppercase' }}
                        type="submit"
                        value="Add to cart"
                      />
                    </div>
        ...
        <div className="w-layout-blockcontainer container product-page-intro w-container">
          ...
          <div className="content-wrapper intro-pdf">
            <div className="image-wrapper chip-single-pdp">
              <div className="hidden md:flex chip-call-out _02">
                <div className="image-wrapper pdp-arrow-02" data-snaxxo-animate >
                  <div style={{ color: bgColor }} className="content-image _100 w-embed">
                    <svg style={{ width: 'inherit', height: 'inherit' }} viewBox="0 0 356 275" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="call-out-inner-text-box _02" data-snaxxo-animate >
                  <div style={{ color: bgColor }} className="call-out-title font-anton">So Tangy</div>
                </div>
              </div>
              <div className="hidden md:flex chip-call-out _03">
                <div className="image-wrapper pdp-arrow-03" data-snaxxo-animate >
                  <div style={{ color: bgColor }} className="content-image _100 w-embed">
                    <svg style={{ width: 'inherit', height: 'inherit' }} viewBox="0 0 338 301" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="call-out-inner-text-box _03" data-snaxxo-animate >
                  <div style={{ color: bgColor }} className="call-out-title font-anton">Plant based &amp; Delicious</div>
                </div>
              </div>
              <div className="hidden md:flex chip-call-out _01">
                <div className="call-out-inner-text-box _01" data-snaxxo-animate >
                  <div style={{ color: bgColor }} className="call-out-title font-anton">Beautifully Bite Sized</div>
                </div>
                <div className="image-wrapper pdp-arrow-01" data-snaxxo-animate >
                  <div style={{ color: bgColor }} className="content-image _100 w-embed">
                    <svg style={{ width: 'inherit', height: 'inherit' }} viewBox="0 0 268 356" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <img className="content-image _100" src={product.image} alt={product.name} data-snaxxo-animate />
            </div>
