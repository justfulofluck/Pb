    ...
    <div className="page-wrapper" style={{ opacity: 1, backgroundColor: tintColor }}>
      ...
      <section className="section overflow-hidden" style={{ backgroundColor: '#f2f2ec' }}>
        <div className="w-layout-blockcontainer container product-page-intro w-container">
          ...
          <div className="content-wrapper intro-pdf"><div className="image-wrapper chip-single-pdp"><div className="chip-call-out _02"><div className="image-wrapper pdp-arrow-02" data-snaxxo-animate ><div style={{ color: bgColor }} className="content-image _100 w-embed"><svg style={{ width: 'inherit', height: 'inherit' }} viewBox="0 0 356 275" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          </svg></div></div><div className="call-out-inner-text-box _02" data-snaxxo-animate ><div style={{ color: bgColor }} className="call-out-title font-anton">So Tangy</div></div></div><div className="chip-call-out _03"><div className="image-wrapper pdp-arrow-03" data-snaxxo-animate ><div style={{ color: bgColor }} className="content-image _100 w-embed"><svg style={{ width: 'inherit', height: 'inherit' }} viewBox="0 0 338 301" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
