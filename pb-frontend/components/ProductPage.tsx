...
const ProductPage: React.FC<ProductPageProps> = ({
  ...
  return (
    <div className="page-wrapper" style={{ opacity: 1, backgroundColor: tintColor }}>
        ...
        <div className="w-layout-blockcontainer container product-page-hero w-container">
          <div className="content-wrapper product-page-hero">
            ...
            <div className="product-page-hero-bottom-content">
              ...
              <div className="content-block pdp-02" style={{ width: '100%', minWidth: '300px', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', left: '-160px' }}>
                    ...
                    <div ref={jarWrapperRef} style={{ position: 'relative', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      ...
                      <div
                        dangerouslySetInnerHTML={{
                          ...
                          )}" alt="${product.name}" camera-controls disable-zoom disable-pan disable-tap bounds="tight" min-camera-orbit="auto auto auto" max-camera-orbit="auto auto auto" min-field-of-view="auto" max-field-of-view="auto" touch-action="pan-y" interaction-prompt="none" auto-rotate rotation-speed="20deg" orientation="${product.orientation || '0deg 0deg -15deg'}" style="width: 100%; max-width: 650px; height: 650px; outline: none; margin: 0 auto; pointer-events: auto; animation: floatJar 6s ease-in-out infinite; z-index: 2; position: relative;">
                          </model-viewer>`
                        }}
              ...
              <div className="content-block pdp-03" data-snaxxo-animate>
                <div className="pdp-hero-right-block-content mb-6">
                  <div className="flex items-baseline gap-4">
                    <span style={{ color: '#FFF' }} className="text-5xl font-black tracking-tighter">
                      ₹{product.price.toFixed(0)}
                    </span>
                    {product.originalPrice && product.originalPrice > product.price && (
                      <span style={{ color: 'rgba(255, 255, 255, 0.5)' }} className="text-2xl font-bold line-through">
                        ₹{product.originalPrice.toFixed(0)}
                      </span>
                    )}
                  </div>
                  <p style={{ color: 'rgba(255, 255, 255, 0.7)' }} className="text-[10px] font-black uppercase tracking-[0.2em] mt-1">MRP (Inclusive of all taxes)</p>
                </div>
                <div className="add-to-cart-block-wrapper _02">
                  <form onSubmit={handleAddToCart} className="w-commerce-commerceaddtocartform default-state">
                    <div className="product-page-info-cta-contain flex flex-wrap gap-4 items-center">
                      <div style={{ borderColor: '#FFF' }} className="quantity-wrapper flex items-center border rounded-lg h-[54px] w-[140px] overflow-hidden">
                        <button
                          type="button"
                          onClick={() => setQuantity(prev => Math.max(1, prev - 1))}
                          className="flex-1 h-full flex items-center justify-center text-white hover:bg-white/10 transition-colors border-r border-white/20 text-2xl pb-1"
                        >
                          -
                        </button>
                        <input
                          ...
                          min="1"
                          style={{ color: '#FFF' }}
                          className="w-12 h-full text-center bg-transparent border-none focus:outline-none font-bold text-lg [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                          value={quantity}
                        ...
                        <button
                          ...
                          className="flex-1 h-full flex items-center justify-center text-white hover:bg-white/10 transition-colors border-l border-white/20 text-2xl pb-1"
                        >
                          +
                        </button>
                      </div>
                      <input
                        ...
                        style={{ backgroundColor: '#FFF', color: bgColor, minWidth: '180px', height: '54px', borderRadius: '8px' }}
                        type="submit"
                        value="Add to cart"
                      />
                    </div>
      ...
      <section className="section overflow-hidden" style={{ backgroundColor: '#f2f2ec' }}><div className="w-layout-blockcontainer container product-page-intro w-container"><div className="content-wrapper product-page-intro"><div className="pdp-heading-container"><div className="image-wrapper start-02" data-snaxxo-animate ><div style={{ color: bgColor }} className="content-image _100 w-embed"><svg width="inherit" height="inherit" viewBox="0 0 259 259" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg></div></div><div className="image-wrapper start-01" data-snaxxo-animate ><div style={{ color: bgColor }} className="content-image _100 w-embed"><svg width="inherit" height="inherit" viewBox="0 0 379 424" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg></div></div><div className="w-layout-grid heading-grid center-two-rows tablet-flex-center"><div sa="1" id="w-node-_1456048c-5ed6-222f-c30e-3b71073b440b-98e0d5d3" className="grid-block"><div className="text-box"><h2 style={{ color: bgColor, fontSize: '3.5rem', lineHeight: '1.2', whiteSpace: 'nowrap' }} className="h2-heading no-margin" data-snaxxo-animate>Small size Huge flavor</h2></div></div></div></div></div><div className="content-wrapper intro-pdf"><div className="image-wrapper chip-single-pdp"><div className="chip-call-out _02"><div className="image-wrapper pdp-arrow-02" data-snaxxo-animate ><div style={{ color: bgColor }} className="content-image _100 w-embed"><svg width="inherit" height="inherit" viewBox="0 0 356 275" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="snaxxo-wrapper relative w-full overflow-hidden py-10" style={{ backgroundColor: '#fcf6e5' }}>
