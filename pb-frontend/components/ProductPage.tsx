...
import SnaxxoReviews from './snaxxo/SnaxxoReviews';
...
const ProductPage: React.FC<ProductPageProps> = ({
  ...
  useEffect(() => {
    ...
    // Binds hotspot click events using custom event
    const handleHotspotClick = () => setShowIngredients(true);
    document.addEventListener('openIngredientsHotspot', handleHotspotClick);
    ...
    return () => {
      document.removeEventListener('openIngredientsHotspot', handleHotspotClick);
    };
  }, [product]);
  ...
  const handleAddToCart = (e: React.FormEvent) => {
    ...
    // Simulate adding multiple items or specific pack sizes if needed. For now just passing product to cart.
    ...
    <div className="page-wrapper" style={{ opacity: 1 }}>
          ...
          <div className="content-wrapper product-page-hero">
            <div className="heading-text-box pdp-h1">
              <div className="review-stars-container">
                <div className="review-stars" style={{ color: 'rgb(255, 255, 255)', opacity: 1 }} data-snaxxo-animate>
                  <div style={{ color: bgColor }} className="_5-stars-image w-embed">
                    <svg width="149" height="28" viewBox="0 0 149 28" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_92_22)">
                        <path d="M15.488 1.20585L18.8454 8.07552L26.2315 9.16021C26.8513 9.26352 27.3679 9.67673 27.5746 10.2965C27.781 10.8647 27.6262 11.5362 27.1613 11.9494L21.7896 17.2695L23.0809 24.8107C23.184 25.4305 22.9258 26.0502 22.4094 26.4118C21.8927 26.8251 21.2214 26.8251 20.6532 26.5669L14.0418 23.0029L7.37871 26.5669C6.86219 26.8251 6.19072 26.8251 5.67419 26.4118C5.15769 26.0502 4.89943 25.4305 5.00272 24.8107L6.24236 17.2695L0.870593 11.9494C0.45738 11.5362 0.302423 10.8647 0.45738 10.2965C0.663986 9.67673 1.18051 9.26352 1.80032 9.16021L9.23816 8.07552L12.5439 1.20585C12.8021 0.637684 13.3703 0.276123 14.0418 0.276123C14.6616 0.276123 15.2298 0.637684 15.488 1.20585Z" fill="#FFF" />
                        <path d="M45.7068 1.20561L49.0642 8.07528L56.4503 9.15997C57.07 9.26327 57.5867 9.67649 57.7933 10.2963C57.9998 10.8645 57.8449 11.5359 57.38 11.9492L52.0083 17.2693L53.2996 24.8105C53.4028 25.4302 53.1446 26.05 52.6281 26.4115C52.1115 26.8249 51.4401 26.8249 50.8719 26.5666L44.2605 23.0027L37.5975 26.5666C37.0809 26.8249 36.4095 26.8249 35.8929 26.4115C35.3764 26.05 35.1182 25.4302 35.2215 24.8105L36.4611 17.2693L31.0893 11.9492C30.6761 11.5359 30.5212 10.8645 30.6761 10.2963C30.8827 9.67649 31.3993 9.26327 32.0191 9.15997L39.4569 8.07528L42.7626 1.20561C43.0209 0.63744 43.589 0.275879 44.2605 0.275879C44.8803 0.275879 45.4485 0.63744 45.7068 1.20561Z" fill="#FFF" />
                        <path d="M75.9411 1.20463L79.2986 8.0743L86.6846 9.15899C87.3044 9.2623 87.8211 9.67551 88.0277 10.2953C88.2342 10.8635 88.0793 11.535 87.6144 11.9482L82.2427 17.2683L83.534 24.8095C83.6372 25.4292 83.3789 26.049 82.8625 26.4106C82.3459 26.8239 81.6745 26.8239 81.1063 26.5657L74.4949 23.0017L67.8318 26.5657C67.3153 26.8239 66.6438 26.8239 66.1273 26.4106C65.6108 26.049 65.3526 25.4292 65.4558 24.8095L66.6955 17.2683L61.3237 11.9482C60.9105 11.535 60.7555 10.8635 60.9105 10.2953C61.1171 9.67551 61.6336 9.2623 62.2534 9.15899L69.6913 8.0743L72.997 1.20463C73.2553 0.636464 73.8234 0.274902 74.4949 0.274902C75.1147 0.274902 75.6829 0.636464 75.9411 1.20463Z" fill="#FFF" />
                        <path d="M106.168 1.20561L109.525 8.07528L116.911 9.15997C117.531 9.26327 118.048 9.67649 118.254 10.2963C118.461 10.8645 118.306 11.5359 117.841 11.9492L112.469 17.2693L113.761 24.8105C113.864 25.4302 113.605 26.05 113.089 26.4115C112.572 26.8249 111.901 26.8249 111.333 26.5666L104.721 23.0027L98.0584 26.5666C97.5419 26.8249 96.8704 26.8249 96.3539 26.4115C95.8374 26.05 95.5791 25.4302 95.6824 24.8105L96.922 17.2693L91.5503 11.9492C91.1371 11.5359 90.9821 10.8645 91.1371 10.2963C91.3437 9.67649 91.8602 9.26327 92.48 9.15997L99.9178 8.07528L103.224 1.20561C103.482 0.63744 104.05 0.275879 104.721 0.275879C105.341 0.275879 105.909 0.63744 106.168 1.20561Z" fill="#FFF" />
                        <path d="M136.386 1.20561L139.744 8.07528L147.13 9.15997C147.75 9.26327 148.266 9.67649 148.473 10.2963C148.679 10.8645 148.525 11.5359 148.06 11.9492L142.688 17.2693L143.979 24.8105C144.082 25.4302 143.824 26.05 143.308 26.4115C142.791 26.8249 142.12 26.8249 141.552 26.5666L134.94 23.0027L128.277 26.5666C127.761 26.8249 127.089 26.8249 126.573 26.4115C126.056 26.05 125.798 25.4302 125.901 24.8105L127.141 17.2693L121.769 11.9492C121.356 11.5359 121.201 10.8645 121.356 10.2963C121.562 9.67649 122.079 9.26327 122.699 9.15997L130.137 8.07528L133.442 1.20561C133.701 0.63744 134.269 0.275879 134.94 0.275879C135.56 0.275879 136.128 0.63744 136.386 1.20561Z" fill="#FFF" />
                      </g>
                    </svg>
                  </div>
                  <p className="text-block no-margin">{product.reviewCount} Reviews</p>
                </div>
              </div>
            ...
            <div className="product-page-hero-bottom-content">
              <div className="content-block pdp-01">
                <div className="text-box pdp-description" data-snaxxo-animate>
              ...
              <div className="content-block pdp-02" style={{ width: '100%', minWidth: '300px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <div ref={imageRef} className="image-wrapper main-product-image w-full" style={{ pointerEvents: 'auto', display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '0 auto' }}>
                  {product.name === 'American Nuts Crunchy Peanut Butter' ? (
                    <div ref={jarWrapperRef} style={{ position: 'relative', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      ...
                      <div
                        dangerouslySetInnerHTML={{
                          __html: `<model-viewer src="/3D-assets/AmericanNuts-v1.glb" alt="American Nuts Crunchy Peanut Butter" camera-controls disable-zoom disable-pan disable-tap bounds="tight" min-camera-orbit="auto auto auto" max-camera-orbit="auto auto auto" min-field-of-view="auto" max-field-of-view="auto" touch-action="pan-y" interaction-prompt="none" orientation="0deg 0deg -15deg" style="width: 100%; max-width: 650px; height: 650px; outline: none; margin: 0 auto; pointer-events: auto; animation: floatJar 6s ease-in-out infinite; z-index: 2; position: relative;">
                            <button class="Hotspot" slot="hotspot-ingredients" data-position="-3.2502235374859634 0.95 -0.6053257869421331" data-normal="-0.9554634868436966 -0.11664207435065334 -0.27107960417497645" data-visibility-attribute="visible" id="hotspot-ingredients-btn" onclick="document.dispatchEvent(new CustomEvent('openIngredientsHotspot'))">
                                <div class="HotspotAnnotation">Ingredients</div>
                            </button>
                          </model-viewer>`
                        }}
              ...
              <div className="content-block pdp-03" data-snaxxo-animate>
                <div className="pdp-hero-right-block-content">
                  <p style={{ color: '#FFF' }} className="paragraph">$ {product.price.toFixed(2)} USD</p>
                </div>
                <div className="add-to-cart-block-wrapper _02">
                  <form onSubmit={handleAddToCart} className="w-commerce-commerceaddtocartform default-state">
                    <div className="product-option-02">
                      <select
                        required
                        className="packs-selection w-select"
                        value={packSize}
                    ...
                    <div className="product-page-info-cta-contain">
                      <div style={{ borderColor: '#FFF' }} className="quantity-wrapper">
                        <input
                          type="number"
                          min="1"
                          style={{ borderColor: '#FFF' }}
                          className="w-commerce-commerceaddtocartquantityinput quantity-number"
                          value={quantity}
                      ...
                      <input
                        ...
                        style={{ backgroundColor: '#FFF', color: bgColor, minWidth: '150px' }}
                        type="submit"
                        value="Add to cart"
                      />
                    </div>
      ...
      <section className="section overflow-hidden relative" style={{ padding: 0, height: '70vh', minHeight: '500px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, width: '100%' }}>
          <SnaxxoWave className="flipped" fill="#ffffff" />
        </div>

        {/* Bottom Wave: overlaps the image from below, matching next section's background (#ffffff) */}
        <div style={{ position: 'relative', zIndex: 10, width: '100%' }}>
          <SnaxxoWave className="below" fill="#ffffff" />
        </div>
      </section>

      <div className="snaxxo-wrapper relative w-full overflow-hidden bg-white py-10">
        <div style={{ backgroundColor: 'rgb(123, 60, 255)', color: 'white', padding: '10px 20px', borderRadius: '40px', position: 'absolute', top: '40px', left: '50%', transform: 'translateX(-50%)', zIndex: 10 }} className="top-eyebrow font-bold">
          6 FLAVORS!
        </div>
