  ...
  return (
    <div className="bg-background-light min-h-screen pt-10 pb-20 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-[0.03] z-0">
        <div className="font-anton text-9xl absolute top-20 left-10 rotate-12">?</div>
        <div className="font-anton text-9xl absolute top-1/2 right-20 -rotate-12">Q&A</div>
        <div className="font-anton text-9xl absolute bottom-20 left-1/3 rotate-45">!</div>
      </div>
        ...
        <div className="max-w-2xl mx-auto mb-20 relative">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-5 rounded-2xl border-2 border-slate-900 focus:border-primary focus:ring-0 outline-none text-lg font-bold text-slate-700 shadow-sm transition-all font-satoshi"
            />
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-[#fcfbf9] border-2 border-slate-900 rounded-2xl p-8 relative transform rotate-2 hover:rotate-0 transition-transform duration-300">
              <h3 className="font-bold text-xl text-slate-900 mb-4 font-satoshi">Need More Help?</h3>
