...
const SimpleHeroSlider: React.FC<HeroSliderProps> = ({ slides = [] }) => {
    ...
    return (
        <div className="relative w-full overflow-hidden bg-background-light flex items-center justify-center">
            <img
                src={getMediaUrl((isMobile && activeSlides[current].mobileImage) ? activeSlides[current].mobileImage : (activeSlides[current].image || activeSlides[current].backgroundImage))}
                alt="placeholder"
            ...
            {activeSlides.length > 1 && (
                <>
                    <button
                        ...
                        style={{ color: '#f9bc15' }}
                    >
                        <span className="material-symbols-outlined" style={{ color: '#f9bc15', fontVariationSettings: '"wght" 900' }}>chevron_left</span>
                    </button>
                    <button
                        ...
                        style={{ color: '#f9bc15' }}
                    >
                        <span className="material-symbols-outlined" style={{ color: '#f9bc15', fontVariationSettings: '"wght" 900' }}>chevron_right</span>
                    </button>
