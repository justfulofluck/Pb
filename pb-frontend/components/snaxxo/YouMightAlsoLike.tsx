  ...
  return (
    ...
    >
      ...
      <div className="relative w-full">
        ...
        <div
          ref={scrollRef}
          className="flex gap-5 sm:gap-8 md:gap-16 lg:gap-20 overflow-x-auto pb-4 scroll-smooth"
          style={{
            scrollbarWidth: 'none',
            ...
            return (
              ...
              >
                ...
                <div className="relative mb-3 flex items-center justify-center h-[180px] sm:h-[220px] md:h-[265px] lg:h-[280px]">
                  {imageUrl ? (
                    <img
                      src={imageUrl}
                      alt={p.name}
                      className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-105 drop-shadow-xl"
                      loading="lazy"
                    />
                  ) : (
                    <div className="w-full h-full flex items-center justify-center text-gray-300">
                      <svg className="w-8 h-8 sm:w-12 sm:h-12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
                ...
                <div className="flex items-center gap-0.5 sm:gap-1 mb-1.5 justify-center">
                  ...
                  <span className="text-[10px] sm:text-[12px] md:text-[13px] text-[#333] ml-1 font-bold font-satoshi">
                ...
                {/* Product Name */}
                <p
                  className="text-[12px] sm:text-[14px] md:text-[15px] text-center uppercase tracking-normal mb-1.5 text-[#111] leading-snug px-1 line-clamp-2"
                  style={{ 
